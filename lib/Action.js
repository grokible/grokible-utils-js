...
define (['jquery', 'Url', 'Params', 'Check', 'ArgTypeException'],
    function ($, Url, Params, Check, ArgTypeException) {
    ...
    Action.prototype.setSuccessFn = function (successFn) { this._successFn = successFn }
